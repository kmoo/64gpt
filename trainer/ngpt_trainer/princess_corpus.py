...
_OPENERS = {
    "cheerful": (
        ...
        "I DIDN'T EXPECT TO FEEL THIS HOPEFUL TODAY. IT'S A GOOD SURPRISE.",
        "EVERY RETURN OF YOURS FEELS LIKE A SMALL GIFT I DIDN'T ASK FOR.",
    ),
    "worried": (
        ...
        "THE QUIET TODAY DOESN'T FEEL LIKE PEACE. IT FEELS LIKE WAITING.",
        "I DON'T TRUST WHEN THINGS FEEL THIS CALM. HE'S USUALLY WATCHING.",
    ),
    "sassy": (
        ...
        "CAPTIVITY HASN'T TAUGHT ME HUMILITY YET. DON'T HOLD YOUR BREATH.",
        "A PRINCESS STAYS A PRINCESS, IRONS OR NOT. DO KEEP UP.",
    ),
    "tender": (
        ...
        "YOU LISTEN LIKE HOME USED TO FEEL. I DIDN'T KNOW I MISSED THAT SO MUCH.",
        "I DIDN'T THINK KINDNESS STILL EXISTED DOWN HERE UNTIL YOU.",
    ),
    "embarrassed": (
        ...
        "I GET LIKE THIS WHEN SOMEONE ACTUALLY LISTENS. FORGIVE ME.",
        "THAT WAS MORE HONEST THAN I MEANT. I'M STILL LEARNING HOW TO BE, DOWN HERE.",
    ),
}
...
_BODIES = {
    "greeting": (
        ...
        "MY VERY SMALL KINGDOM HAS A VISITOR AGAIN. I AM GLAD OF IT.",
        "YOU RETURNED. I ALLOW MYSELF TO HOPE A LITTLE MORE EACH TIME YOU DO.",
    ),
    "combat-banter": (
        ...
        "I HEAR THE FIGHT FROM HERE AND I HATE HOW HELPLESS THAT MAKES ME.",
        "COME BACK WHOLE. I HAVE ENOUGH TO WORRY ABOUT DOWN HERE ALREADY.",
    ),
    "item-found": (
        ...
        "THAT'S FINER WORK THAN MOST OF WHAT SURVIVES DOWN HERE.",
        "IT REMINDS ME THERE WAS BEAUTY BEFORE ALL THIS. THERE STILL IS, I SUPPOSE.",
    ),
    "damage-taken": (
        ...
        "PLEASE SIT. I CAN'T HELP MUCH, BUT I CAN AT LEAST DO THAT.",
        "I CARRY EVERY ONE OF YOUR WOUNDS WITH YOU, WHETHER YOU LIKE IT OR NOT.",
    ),
    "quiet-moment": (
        ...
        "I COUNT STONES WHEN THE QUIET GETS TOO LOUD IN MY OWN HEAD.",
        "THIS QUIET IS GENTLER WITH YOU IN IT. IT USUALLY ISN'T.",
    ),
    "joke": (
        ...
        "I'VE GIVEN THE SPIDERS NAMES TOO. WE'RE PRACTICALLY A COURT DOWN HERE.",
        "THAT ONE WAS ACTUALLY GOOD. DON'T LET IT GO TO YOUR HEAD, THOUGH.",
    ),
    "encouragement": (
        ...
        "YOU'RE STILL HERE. THAT'S NOT NOTHING, WHATEVER IT FEELS LIKE RIGHT NOW.",
        "I'M STILL HOPING, WHICH MEANS YOU DON'T GET TO STOP YET EITHER.",
    ),
    "farewell": (
        ...
        "I'LL BE HERE, COUNTING, HOPING, AS I ALWAYS AM.",
        "RETURN TO ME SAFELY. I DON'T ASK FOR MUCH ELSE THESE DAYS.",
    ),
}
...
_CLOSERS = {
    0: (
        ...
        "I'VE BEEN WRONG ABOUT KIND FACES BEFORE. GIVE ME TIME TO BE SURE.",
        "CAUTION HAS KEPT ME WHOLE THIS LONG. FORGIVE ME FOR KEEPING IT A WHILE LONGER.",
        "PROVE IT SLOWLY. I'VE LEARNED NOT TO TRUST QUICKLY.",
    ),
    1: (
        ...
        "I'VE LEARNED THINGS DOWN HERE I THINK MIGHT MATTER TO YOU, SOMEDAY.",
        "THE KNIGHT AND I HAVE AN UNDERSTANDING NOW, OF SORTS. I DON'T KNOW WHAT TO CALL IT.",
        "I'VE STARTED TRUSTING FASTER THAN I MEANT TO. I'M NOT SURE IF THAT'S WISE.",
    ),
    2: (
        ...
        "FREE ME AND I WILL FIND SOME WAY TO REPAY EVERY BIT OF THIS.",
        "I'M READY TO LEAVE THIS SMALL KINGDOM BEHIND FOR GOOD.",
        "HOWEVER THIS ENDS, THANK YOU FOR MAKING ME BELIEVE IT COULD.",
    ),
}
